...
export function collectDom() {
  const ids = [
    ...
    "saveProjectButton", "projectInput", "surfacePanel", "surfaceCloseButton", "imagePanel", "imageCloseButton", "imageSummary", "addLayerButton", "layerList", "imageLayerCard", "imageLayerThumb", "imageLayerStatus", "imageLayerVisibilityButton", "moveLayerUpButton", "moveLayerDownButton",
    "preview3dPanel", "preview3dCloseButton", "preview3dSummary", "preview3dTransparencyInput", "preview3dWarningPanel", "preview3dWarningCloseButton", "preview3dWarningCancelButton", "preview3dWarningViewButton", "helpPanel", "helpCloseButton", "helpButton",
